                    ...
                    <div class="navbar">
                        <ul class="nav" id="navmenu">
                            <li class="dropdown">
                                ...
                                <a href="/index.php"><img src="../img/icon/flags/arabic.png" alt="FR" />&nbsp;العربية</a>
                                <ul class="dropdown-menu">
                                    <li><a href="/fr/index.php"><img src="../img/icon/flags/french.png" alt="FR" />&nbsp;Français</a></li>
                                    <li><a href="/de/index.php"><img src="../img/icon/flags/german.png" alt="DE" />&nbsp;Deutschland</a></li>
                                    <li><a href="/nl/index.php"><img src="../img/icon/flags/netherlands.png" alt="NL" />&nbsp;Nederland</a></li>
                                    <li><a href="/es/index.php"><img src="../img/icon/flags/spain.png" alt="ES" />&nbsp;Español</a></li>
                                </ul>
