<?php
    ...
    $properties = $propertyManager->getPropertyForRent();
    //language settings
    $pageTitle = "";
    $title = "";
    $moreButton = "";
                                ...
                                <li class="span4 <?= $property->category() ?>">
                                  <div class="product-item">
                                    <div class="imagewrapper">
                                      ...
                                      <span class="price"><a class="more-button" href="rent-property.php?sslapi=<?= uniqid().date('sihdmY') ?>&baohyu=<?= $property->id() ?>&nuwapk=<?= date('ihsdmY') ?>"><?= $moreButton ?></a></span>
                                    </div>
                                    <h3><a href="rent-property.php?sslapi=<?= uniqid().date('sihdmY') ?>&baohyu=<?= $property->id() ?>&nuwapk=<?= date('ihsdmY') ?>" title=""><?= $property->$propertyName() ?></a></h3>
                                    <ul class="title-info">
